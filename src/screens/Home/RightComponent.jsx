...
const RightComponent = () => {
  ...
  // Access modal and playground context
      ...
      {Object.entries(folders).map(([folderId, folder]) => (
        <FolderCard key={folderId}>
          <Header>
            ...
            {/* Folder action icons: delete, edit, add playground */}
            <FolderIcons>
          ...
          {/* List all playgrounds (cards) inside the folder */}
          <PlayGroundCards>
